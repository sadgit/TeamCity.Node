...
<tr>
  <th><label for="${bean.targets}">Bower:</label></th>
  <td>
...
<tr>
  <th><label for="${bean.targets}">Bower File:</label></th>
  <td>
    <props:textProperty name="${bean.file}" className="longField"/>
    <span class="smallNote">
      Specify bower file path relative to checkout directory.
      Leave blank to use Bowerfile.{js,coffee}
    </span>
    <span class="error" id="error_${bean.file}"></span>
  </td>
</tr>
